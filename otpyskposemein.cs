...
namespace triumph
{
    public partial class otpyskposemein : Form
    {
        public otpyskposemein()
        {
            InitializeComponent();
            osnovnoy();
        }
        ...
        private readonly string examp = @"D:\Работа\Крылова А.А. дипломная работа\ШаблонОтпускаПоСемейным.docx";
        ...
        private void Button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                WordDocument.SaveAs(@"D:\Работа\Крылова А.А. дипломная работа\ДоговорОтпускаПоСемейным.docx");
