...
namespace triumph
{
    public partial class pesiya : Form
    {
        public pesiya()
        {
        ...
        private readonly string examp = @"D:\Работа\Крылова А.А. дипломная работа\ШаблонПенсия.docx";
        ...
        private void Button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                WordDocument.SaveAs(@"D:\Работа\Крылова А.А. дипломная работа\ДоговорПенсия.docx");
