...
namespace triumph
{
    public partial class ysnovlen : Form
    {
        public ysnovlen()
        {
        ...
        private readonly string examp = @"D:\Работа\Крылова А.А. дипломная работа\ШаблонОтпускаУсыновление.docx";
        ...
        private void Button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                WordDocument.SaveAs(@"D:\Работа\Крылова А.А. дипломная работа\ДоговорОтпускаУсыновление.docx");
